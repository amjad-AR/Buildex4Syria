...
import { getCeilings, Material } from '../../services/materialsService';

export default function CeilingsScreen() {
    ...
    const fetchMaterials = async () => {
        try {
            setError(null);
            const { data, error: fetchError } = await getCeilings();
            ...
            setError('Failed to load ceiling materials');
        } finally {
            setIsLoading(false);
            setRefreshing(false);
        }
